...
export const UserRegister = async (req, res) => {
  try {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #e67300; font-size: 20px; margin-bottom: 20px;">
        Welcome to Alrkn Alraqy Hotel Management!
      </h2>
      ...
      <div style="text-align: center; margin: 30px 0;">
        <div style="background-color: #f7f7f7; border: 2px solid #e67300; padding: 20px; border-radius: 10px; display: inline-block;">
          <span style="font-size: 32px; font-weight: bold; color: #e67300; letter-spacing: 5px;">
            ${otp}
          </span>
        </div>
      </div>
      ...
      <p style="font-size: 14px; color: #333;">
        Best regards,<br>Alrkn Alraqy Hotel Management Team
      </p>
    </div>
  `;
